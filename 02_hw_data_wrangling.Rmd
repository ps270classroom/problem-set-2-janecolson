...
top_15_house_candidates <- house_ads |>
  arrange(desc(impressions_millions)) |>
  slice(1:15)
  
fb_top_plot <- ggplot(top_15_house_candidates, aes(x = impressions_millions, y = reorder(cand_name_last, impressions_millions), fill = party)) +
